    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-third">
        <div class="w3-white w3-text-grey w3-card-4">
          ...
          <div class="w3-container">
            ...
            <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $email;?>l</p>
      ...
      <div class="w3-twothird">
        ...
        <?php for ($i = 0; $i < count($expirience); $i++):?>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $expirience[$i]['job'];?></p></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $expirience[$i]['period'];?></h6>
